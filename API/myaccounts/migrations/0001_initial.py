# Generated by Django 4.2.7 on 2024-01-04 19:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('email_validation_token', models.CharField(blank=True, max_length=100, null=True)),
                ('is_validated', models.BooleanField(default=False)),
                ('is_verified', models.BooleanField(default=False)),
                ('current_profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='current_profile_switch', to='myaccounts.profile')),
                ('intended_profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='intended_profile_switch', to='myaccounts.profile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='photographer_profile', to='myaccounts.profile')),
                ('profile_switch', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='photographer_switch', to='myaccounts.profileswitch')),
        ...
        migrations.AddField(
            model_name='client',
            name='profile',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='client_profile', to='myaccounts.profile'),
        ),
        migrations.AddField(
            model_name='client',
            name='profile_switch',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='client_switch', to='myaccounts.profileswitch'),
        ),
        migrations.AddField(
            model_name='client',
            name='user',
